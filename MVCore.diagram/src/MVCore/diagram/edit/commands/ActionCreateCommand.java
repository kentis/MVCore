...
public class ActionCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		MVCore.Action newElement = MVCore.MVCoreFactory.eINSTANCE
				.createAction();

		MVCore.Controller owner = (MVCore.Controller) getElementToEdit();
	 ...
	 * @generated
	 */
	protected void doConfigure(MVCore.Action newElement,
