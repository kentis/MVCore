...
public class AttributeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		MVCore.Attribute newElement = MVCore.MVCoreFactory.eINSTANCE
				.createAttribute();

		MVCore.Domain owner = (MVCore.Domain) getElementToEdit();
	 ...
	 * @generated
	 */
	protected void doConfigure(MVCore.Attribute newElement,
