...
public class ControllerEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new MVCore.diagram.edit.policies.ControllerItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new MVCore.diagram.edit.policies.ControllerCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MVCoreControllerNode();
	}

	/**
	 * @generated
	 */
	public MVCoreControllerNode getPrimaryShape() {
		return (MVCoreControllerNode) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MVCore.diagram.edit.parts.ControllerNameEditPart) {
			((MVCore.diagram.edit.parts.ControllerNameEditPart) childEditPart)
	 ...
	 * @generated
	 */
	public class MVCoreControllerNode extends RoundedRectangle {
