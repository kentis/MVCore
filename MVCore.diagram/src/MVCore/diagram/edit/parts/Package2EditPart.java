...
public class Package2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new MVCore.diagram.edit.policies.Package2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MVCore.diagram.edit.policies.Package2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MVCore.diagram.edit.parts.PackageNameEditPart) {
			((MVCore.diagram.edit.parts.PackageNameEditPart) childEditPart)
