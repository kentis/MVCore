...
public class DomainItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (MVCore.diagram.part.MVCoreVisualIDRegistry
					.getVisualID(incomingLink) == MVCore.diagram.edit.parts.ReferenceEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (MVCore.diagram.part.MVCoreVisualIDRegistry
					.getVisualID(outgoingLink) == MVCore.diagram.edit.parts.ReferenceEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getReorientRelationshipCommand(
		...
		case MVCore.diagram.edit.parts.ReferenceEditPart.VISUAL_ID:
			return getGEFWrapper(new MVCore.diagram.edit.commands.ReferenceReorientCommand(
					req));
		}
