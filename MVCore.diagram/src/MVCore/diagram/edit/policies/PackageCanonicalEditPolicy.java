...
public class PackageCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(MVCore.MVCorePackage.eINSTANCE
					.getPackage_Members());
			myFeaturesToSynchronize.add(MVCore.MVCorePackage.eINSTANCE
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = MVCore.diagram.part.MVCoreVisualIDRegistry
				.getVisualID(view);
		return visualID == MVCore.diagram.edit.parts.ControllerEditPart.VISUAL_ID
				|| visualID == MVCore.diagram.edit.parts.DomainEditPart.VISUAL_ID
				|| visualID == MVCore.diagram.edit.parts.Package2EditPart.VISUAL_ID;
	}
