...
public class MVCoreViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return MVCore.diagram.edit.parts.PackageEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return MVCore.diagram.edit.parts.ControllerEditPart.VISUAL_ID == visualID
				...
				|| MVCore.diagram.edit.parts.Package3EditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(MVCore.diagram.edit.parts.PackageEditPart.MODEL_ID);
	...
	private void stampShortcut(View containerView, Node target) {
		if (!MVCore.diagram.edit.parts.PackageEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", MVCore.diagram.edit.parts.PackageEditPart.MODEL_ID); //$NON-NLS-1$
