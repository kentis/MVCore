...
/**
 * This is the item provider adapter for a {@link MVCore.Package} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PackageItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MVCorePackage.Literals.PACKAGE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MVCorePackage.Literals.PACKAGE__SUB_PACKAGES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((MVCore.Package)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MVCore.Package.class)) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MVCorePackage.Literals.PACKAGE__MEMBERS,
				 MVCoreFactory.eINSTANCE.createMVCoreClass()));

		newChildDescriptors.add
			(createChildParameter
				(MVCorePackage.Literals.PACKAGE__MEMBERS,
				 MVCoreFactory.eINSTANCE.createDomain()));
