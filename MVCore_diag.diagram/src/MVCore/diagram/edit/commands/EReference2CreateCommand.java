...
public class EReference2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EReference2CreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return MVCore.diagram.edit.policies.MVCoreBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateEReference_4003(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		MVCore.diagram.providers.ElementInitializers.getInstance()
				.init_EReference_4003(newElement);
