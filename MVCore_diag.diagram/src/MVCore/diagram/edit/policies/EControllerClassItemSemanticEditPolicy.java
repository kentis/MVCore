 ...
 * @generated
 */
public class EControllerClassItemSemanticEditPolicy extends
		MVCore.diagram.edit.policies.MVCoreBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public EControllerClassItemSemanticEditPolicy() {
		super(MVCore.diagram.providers.MVCoreElementTypes.EControllerClass_2001);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MVCore.diagram.providers.MVCoreElementTypes.EAction_3002 == req
				.getElementType()) {
			return getGEFWrapper(new MVCore.diagram.edit.commands.EActionCreateCommand(
					req));
		}
