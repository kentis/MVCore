 ...
 * @generated
 */
public class EMVCPackageCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<MVCore.diagram.part.MVCoreNodeDescriptor> childDescriptors = MVCore.diagram.part.MVCoreDiagramUpdater
				.getEMVCPackage_1000SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = MVCore.diagram.part.MVCoreVisualIDRegistry
				.getVisualID(view);
		return visualID == MVCore.diagram.edit.parts.EControllerClassEditPart.VISUAL_ID
				|| visualID == MVCore.diagram.edit.parts.EDomainClassEditPart.VISUAL_ID
				|| visualID == MVCore.diagram.edit.parts.EPackageEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<MVCore.diagram.part.MVCoreNodeDescriptor> childDescriptors = MVCore.diagram.part.MVCoreDiagramUpdater
				.getEMVCPackage_1000SemanticChildren((View) getHost()
						.getModel());
		...
		for (Iterator<MVCore.diagram.part.MVCoreNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			MVCore.diagram.part.MVCoreNodeDescriptor next = descriptorsIterator
					.next();
			String hint = MVCore.diagram.part.MVCoreVisualIDRegistry
		...
		for (MVCore.diagram.part.MVCoreNodeDescriptor next : childDescriptors) {
			String hint = MVCore.diagram.part.MVCoreVisualIDRegistry
					.getType(next.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = MVCore.diagram.part.MVCoreVisualIDRegistry
			...
			for (Iterator<MVCore.diagram.part.MVCoreLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				MVCore.diagram.part.MVCoreLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	...
	private Collection<MVCore.diagram.part.MVCoreLinkDescriptor> collectAllLinks(
		...
		case MVCore.diagram.edit.parts.EMVCPackageEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MVCore.diagram.part.MVCoreDiagramUpdater
						.getEMVCPackage_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case MVCore.diagram.edit.parts.EControllerClassEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MVCore.diagram.part.MVCoreDiagramUpdater
						.getEControllerClass_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case MVCore.diagram.edit.parts.EDomainClassEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MVCore.diagram.part.MVCoreDiagramUpdater
						.getEDomainClass_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case MVCore.diagram.edit.parts.EPackageEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MVCore.diagram.part.MVCoreDiagramUpdater
						.getEPackage_2004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case MVCore.diagram.edit.parts.EReferenceEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(MVCore.diagram.part.MVCoreDiagramUpdater
						.getEReference_4001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
