...
public class EPackageItemSemanticEditPolicy extends
	...
	public EPackageItemSemanticEditPolicy() {
		super(MVCore.diagram.providers.MVCoreElementTypes.EPackage_2004);
	}
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (MVCore.diagram.providers.MVCoreElementTypes.EClass_3006 == req
				.getElementType()) {
			return getGEFWrapper(new MVCore.diagram.edit.commands.EClassCreateCommand(
					req));
		}
		if (MVCore.diagram.providers.MVCoreElementTypes.EPackage_3007 == req
				.getElementType()) {
			return getGEFWrapper(new MVCore.diagram.edit.commands.EPackage2CreateCommand(
					req));
		}
