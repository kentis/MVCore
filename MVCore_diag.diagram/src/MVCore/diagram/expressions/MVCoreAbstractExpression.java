 ...
 * @generated
 */
public abstract class MVCoreAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = MVCore.diagram.part.MVCoreDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected MVCoreAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
