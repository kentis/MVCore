 ...
 * @generated
 */
public class MVCoreDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public MVCoreDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof MVCore.diagram.navigator.MVCoreDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((MVCore.diagram.navigator.MVCoreDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new MVCore.diagram.navigator.MVCoreDomainNavigatorItem(
